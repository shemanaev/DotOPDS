...
namespace DotOPDS.Utils
{
    public class Genres
    {
        ...
        private Genres()
        {
            ...
            localized.Add("adv_history", T._("History"));
            ...
            localized.Add("humor_fantasy", T._("humor_fantasy"));
            ...
            localized.Add("popadanec", T._("popadanec "));
            ...
            localized.Add("prose_epic", T._("Epic"));
